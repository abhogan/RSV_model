...
##########################################################
# run model using parameters from fitting to lab-confirmed RSV hospitalisations in Western Australia
# the output r will give you, as a list, the solutions for S, E, I, R, Incidence, and Detected Incidence, for each time point.
...
# plot 4-month age group to see how solution looks
plot(r$I[,5])
q <- r$I[,5]
q <- findpeaks(q)
...
# get second-last peak, and select range of model output accordingly (from plotting alongisde WA data)
...
# keep the time period of interest. Incidence represents all infections; DetIncidence represents detected infections (i.e. hospitalised, lab-confirmed cases)
# These outputs can be summarised from the list r in whatever way you need.
